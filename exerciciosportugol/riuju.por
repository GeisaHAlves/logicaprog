programa
{
	...
	funcao inicio()
	{
	inteiro result1, result2
	escreva("Primeira expressão: 2 + 3 - 5 * 8 - 4 + 354 - 521 + 7 * 66", "\n")
	
	result1 = (2 + 3 - (5 * 8) - 4 + 354 - 521 + (7 * 66))
	escreva("O resultado da primeira expressão é ", result1, "\n")
